...
## `height` vs. `earn`
ggplot(heights_df, aes(x=height, y=earn)) + geom_point(na.rm = TRUE)
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(na.rm = TRUE)
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(na.rm = TRUE)

## Re-create the three scatterplots and add a regression trend line using
## the `geom_smooth()` function
## `height` vs. `earn`
ggplot(heights_df, aes(x=earn, y=earn)) + geom_point(na.rm = TRUE) + 
  geom_smooth()
## `age` vs. `earn`
ggplot(heights_df, aes(x=age, y=earn)) + geom_point(na.rm = TRUE) + 
  geom_smooth()
## `ed` vs. `earn`
ggplot(heights_df, aes(x=ed, y=earn)) + geom_point(na.rm = TRUE) + geom_smooth()

## Create a scatterplot of `height`` vs. `earn`.  Use `sex` as the `col` (color) attribute
ggplot(heights_df, aes(x=height, y=earn, col=sex)) + geom_point(na.rm = TRUE)
